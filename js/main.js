...
async function getTemps(keyWord) {
    ...
    let d = new Date();
    document.getElementById("today").innerHTML = d.toLocaleDateString('en',{weekday: 'long'})
    document.getElementById("dayDate").innerHTML = d.toLocaleDateString('en',{day: '2-digit'}) + ` ` + d.toLocaleDateString('en',{month: 'long'});
